        ...
        public DestinationsSeed()
        {
            Items = new List<DestinationInfo>
            {
                ...
                new DestinationInfo
                {
                    ...
                    VaccintionRequirements = "Yellow Fever\n a yellow fever vaccination certificate is required for travellers aged 9 months or over arriving from countries with risk of yellow fever transmission."
